...
`v0.6.0` publishes Bunny's frame-commons work: coordinate law, checked numeric
preconditions, deterministic property corpora, fixed matrix and affine
transform primitives, and deterministic contract-profile witnesses generated by
`bunny-wesley/0.6.0`.

See [CHANGELOG.md](CHANGELOG.md) for release notes and
[ROADMAP.md](ROADMAP.md) for the remaining release train.
