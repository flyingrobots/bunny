...
This is a living reference document, not a historical design proposal.
...
changes Bunny's coordinate behavior must update this file in the same change or
explicitly state why the coordinate law is unaffected.
...
This file is the source of truth for current coordinate law.
